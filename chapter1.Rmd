...
*** =hint
Schauen Sie, wie der Wert 4 im Beispiel der Variable `my_var` zugeteilt wurde. Machen Sie genau das Gleiche im Editor, aber statt demn Wert 4 ordnen Sie die 42 der Variable `x` zu.
...
`my_numeric <- 42` um der Variable `my_numeric` den Wert 42 zu zuweisen. 
